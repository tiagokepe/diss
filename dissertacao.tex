...
\title{Self-tuning based on data sampling}
\author{Tiago Rodrigo Kepe}
\advisortitle{Advisor} % ou Orientador
\advisorname{Prof. Dr. Eduardo C. de Almeida}
\advisorplace{Informatics Department, Federal University of Paraná, Brazil}
\city{Curitiba}
\year{2013}

\banca        % nao insira o nome do orientador, ja eh feito automaticamente
{Prof. Dr. Marcos D. Del Fabro}{Informatics Department, Federal University of Paraná}
{Prof. Dr. Gerson Sunyé}{Informatics Department, INRIA - University of Nantes, France}
{}{}
...
\tableofcontents
\listoffigures
\addcontentsline{}{chapter}{\MakeUppercase{Pictures List}}
\newpage
\listoftables
\addcontentsline{}{chapter}{\MakeUppercase{Tables List}}
